...
var experimentName = '${nameprefix}chaos-aks-degradation-legacy'
var chaosAksSelectorId = guid('${nameprefix}-chaos-aks-leg-selector-id')
...
// target: aks
resource chaosakstarget 'Microsoft.Chaos/targets@2025-01-01' = {
...
resource chaosaksexperiment 'Microsoft.Chaos/experiments@2025-01-01' = {
  name: experimentName
  location: location  
  identity: {
    type: 'SystemAssigned'
